...
contract Ownable {
    ...
    event OwnerShipIsTransfered(address newOwner);
    ...
    modifier onlyOwner() {
      require(_owner == msg.sender, "Caller is not a contract owner");
      _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Owner is not changed");
        _owner = newOwner;
        emit OwnerShipIsTransfered(newOwner);
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "is already the owner of tokenid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "from has to be the owner of the given token");
